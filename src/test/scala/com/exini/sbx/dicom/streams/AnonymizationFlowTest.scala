...
import com.exini.dicom.data.DicomParts.{DicomPart, ElementsPart, ValueChunk}
import com.exini.dicom.data._
import com.exini.dicom.streams.CollectFlow.collectFlow
import com.exini.dicom.streams.{DicomFlows, ElementFlows}
