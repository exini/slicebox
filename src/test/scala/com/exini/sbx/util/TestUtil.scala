...
import com.exini.dicom.data.{Elements, Tag, tagToString}
import com.exini.dicom.streams.ElementFlows.elementFlow
import com.exini.dicom.streams.ElementSink.elementSink
import com.exini.dicom.streams.ParseFlow
import com.exini.sbx.anonymization.AnonymizationProtocol.AnonymizationKey
...
import com.exini.sbx.metadata.MetaDataProtocol.{SeriesSource, SeriesTag}
import com.exini.sbx.metadata.{MetaDataDAO, PropertiesDAO}
import com.exini.sbx.seriestype.SeriesTypeDAO
import com.exini.sbx.seriestype.SeriesTypeProtocol.{SeriesSeriesType, SeriesType}
