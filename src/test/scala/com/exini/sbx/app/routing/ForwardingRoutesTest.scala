...
import com.exini.sbx.app.GeneralProtocol.{Destination, DestinationType, Source, SourceType}
import com.exini.sbx.forwarding.ForwardingProtocol.ForwardingRule
